...
from app.students.schemas import Student, SStudentAdd
...
async def get_student_by_id(student_id: int) -> Student | dict:
...
async def get_student_by_filter(request_body: RBStudent = Depends()) -> Student | dict:
